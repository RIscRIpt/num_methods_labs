...
\includeimage{../plots/bisect_9.png}{fig:bisect_9}{График функции $x^2 + \sin(x)$ на интервале $[-2; +2]$.}

\begin{center}
    \begin{tabular}{CCRC}
        \text{Функция} & \text{Точность} & \text{Найденные корни} & \text{Число итераций} \\
        \hline
        \multirow{4}{*}{$e^{2x} \cdot \sin(x) - 18$} & 10^{-2} & 1.45348 & 8 \\
                                                     & 10^{-4} & 1.44897 & 14 \\
                                                     & 10^{-6} & 1.44891 & 21 \\
                                                     & 10^{-9} & 1.44891 & 31 \\
        \hline
        \multirow{8}{*}{$x^2 + \sin(x)$} & \multirow{2}{*}{$10^{-2}$} & -0.882812 & 9 \\
                                         &                            & -0.0031134 & 9 \\
        \cdashline{2-4}
        & \multirow{2}{*}{$10^{-4}$} & -0.87677 & 16 \\
        &                            & 7.87441 \cdot 10^{-5} & 15 \\
        \cdashline{2-4}
        & \multirow{2}{*}{$10^{-6}$} & -0.876727 & 22 \\
        &                            & 6.58521 \cdot 10^{-7} & 22 \\
        \cdashline{2-4}
        & \multirow{2}{*}{$10^{-9}$} & -0.876726 & 32 \\
        &                            & 2.85042 \cdot 10^{-10} & 32 \\
        \hline
    \end{tabular}
\end{center}
