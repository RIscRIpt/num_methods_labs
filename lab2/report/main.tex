...
\end{itemize}
В результате было разработано две программы на языке <<C++>> реализующие данные методы. А для МНК было сделано только составление (и вывод) универсальной МНК СЛАУ.
